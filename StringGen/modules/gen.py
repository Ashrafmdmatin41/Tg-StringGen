...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Matiz_Techz"))
        else:
            ...
            await client.join_chat("Matiz_Techz")
    except KeyError:
        pass
    try:
